...
export default function Header() {
    ...
    // Khi chúng ta chuyển trang thì Header chỉ bị re-render do react router thay dung chung mainLayout do la tinh nang cua react router
                                        ...
                                        <div className='p-2'>
                                            ...
                                            <div className='mt-5'>
                                                {purchasesIncart.slice(0, MAX_PURCHASES).map((purchase) => (
                                                    <div
                                                        className='mt-2 flex cursor-pointer py-2 hover:bg-gray-100'
                                                        key={purchase._id}
                                                    >
