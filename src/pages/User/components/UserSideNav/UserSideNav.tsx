    ...
    return (
        <div>
            <div className='flex items-center border-b border-b-gray-200 py-4'>
                ...
                >
                    <img src={getAvatarUrl(profile?.avatar as string)} alt='' className='h-full w-full object-cover' />
                </Link>
                <div className='flex-grow pl-4'>
                    <div className='mb-1 truncate font-semibold text-gray-600'>{userName}</div>
