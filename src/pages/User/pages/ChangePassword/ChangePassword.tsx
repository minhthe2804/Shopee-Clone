...
export default function ChangePassword() {
    ...
    const onSubmit = handleSubmit(async (data) => {
        try {
            ...
            if (
                isAxiosUnprocessableEntityError<ErrorResponse<Pick<BodyUpdateProfile, 'password' | 'newPassword'>>>(
                    error
                )
            ) {
                ...
                if (formError) {
                    Object.keys(formError).forEach((key) => {
                        setError(key as keyof FormData, {
                            message: formError[key as keyof Pick<BodyUpdateProfile, 'password' | 'newPassword'>],
                            type: 'Server'
                        })
                    })
                }
