...
export default function Cart() {
    ...
    const deleteProductMutation = useMutation({
        mutationFn: (product_id: string[]) => purchaseApi.deletePurchase(product_id),
        onSuccess: () => {
            refetch()
        }
    })
                ...
                {extendedPurchases.length > 0 ? (
                    <>
                        ...
                        <div
                            className={
                                extendedPurchases.length > 0
                                    ? 'sticky bottom-0 z-10 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'
                                    : 'sticky bottom-0 mt-8 flex flex-col rounded-sm border border-gray-100 bg-white p-5 shadow sm:flex-row sm:items-center'
                            }
                        >
                            <div className='flex items-center'>
                                <div className='flex flex-shrink-0 items-center justify-center pr-3'>
                            ...
                            <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
                                ...
                                <Button
                                    className={
                                        buyProductsMutation.isPending || extendedPurchases.length === 0
                                            ? 'mt-5 flex h-10 w-52 items-center justify-center bg-red-400 text-sm uppercase text-white sm:ml-4 sm:mt-0'
                                    ...
                                    disabled={buyProductsMutation.isPending || extendedPurchases.length === 0}
